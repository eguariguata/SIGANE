    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="user-info">
                ...
                <div>Eikel<strong> Guariguata</strong></div></a>
                <ul class="dropdown-menu dropdown-user"><!-- dropdown user-->
                    <a href="logout.php"><i class="fa fa-users fa-fw"></i><b>Crear Usuario</b></a>
                        <li class="divider"></li>
     ...
     <strong>Datos Alumnos</strong>
        ...
        <br>
            ...
            <div class="row form-group">
                ...
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">NÂ° TelÃ©fono</label>
                    <input type="text" id="telefono_alumno" class="form-control">   
                </div>
            </div>
             <div class="row form-group">
                <div class="col col-md-12">
                    <label for="text-input" class=" form-control-label">DirecciÃ³n</label>
        ...
        <div class="card-body card-block">
            <div class="card-header">
                <br>
            <strong>Datos</strong> Familiares
        </div>
        <br>
         <div class="row form-group">
        ...
        <div class="card-body card-block">
            <div class="card-header">
                <br>
            <strong>Datos del</strong> Representante Legal
            </div>
            <br>
            <div class="row form-group">
                <div class="col col-md-6">
            ...
            <div class="row form-group">
                <div class="col col-md-4">
                    <label for="text-input" class=" form-control-label">Profecion</label>
                ...
                <div class="col col-md-4">
                    <label for="text-input" class=" form-control-label">Numero Telefonico</label>
